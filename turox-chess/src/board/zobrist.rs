...
use super::Board;
use crate::types::{CastlingRights, Color, ColoredPiece, Square};
...
/// incidentally, nonzero (`turox_rng::xorshift64star`'s "zero is a fixed point"
...
/// Generates the full key table by walking `turox_rng::xorshift64star` forward
...
/// key through `turox_rng::xorshift64star` in the same fixed order `generate_keys`
/// produces them in.
///
